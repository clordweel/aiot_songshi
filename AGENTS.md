...
4. **环境事实**：先读 **[docs/aiot/env/server-baseline.md](docs/aiot/env/server-baseline.md)**（可提交）；站点线 [frappe-site-baseline.md](docs/aiot/env/frappe-site-baseline.md)。密钥等用 `docs/aiot/env/*.local.md`（gitignore）。
